...
{
	if (test_bit(0, &ek_at91_adc_data.channels_used))
		at91_set_A_periph(AT91_PIN_PC0, 0);
	if (test_bit(1, &ek_at91_adc_data.channels_used))
		at91_set_A_periph(AT91_PIN_PC1, 0);
	if (test_bit(2, &ek_at91_adc_data.channels_used))
		at91_set_A_periph(AT91_PIN_PC2, 0);
	if (test_bit(3, &ek_at91_adc_data.channels_used))
		at91_set_A_periph(AT91_PIN_PC3, 0);

	if (ek_at91_adc_data.use_external_triggers)
		at91_set_A_periph(AT91_PIN_PA22, 0);

	return platform_device_register(&at91_adc_device);
}
